...
void MyServer::dispatch_msg(
    ...
    LOG_INFO << "recv service_name: " << service_name;
    LOG_INFO << "recv method_name: " << method_name;
    LOG_INFO << "recv type: " << md->input_type()->name();
    LOG_INFO << "resp type: " << md->output_type()->name();
